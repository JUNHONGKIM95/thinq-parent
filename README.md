...
| 화면 | 파일 | 기능 |
|------|------|------|
| 맘BTI 메뉴 | `MombtiMenuScreen.jsx` | 검사 소개 및 시작 |
| 검사 진행 | `MombtiTestScreen.jsx` | 24문항 (6문항씩 4페이지) |
| 결과 상세 | `MombtiDetailScreen.jsx` | 16개 유형별 상세 분석 |
| 최근 결과 | `MombtiLatestResultScreen.jsx` | 마지막 검사 결과 조회 |

#### MY 페이지 (2개 화면)

| 화면 | 파일 | 기능 |
|------|------|------|
| MY 메인 | `MyScreen.jsx` | 프로필, 일기/맘BTI/일정 바로가기 |
| 아이 프로필 | `ChildProfileScreen.jsx` | 태명 수정, 출산 예정일 관리 |
